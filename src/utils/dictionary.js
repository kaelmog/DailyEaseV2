...
export const dict = {
  id: {
    ...
    dash_subtitle: "Mau ngapain hari ini?",
    ...
    login_pin_label: "Password / PIN",
    login_pin_ph: "••••••••",
    login_btn: "Masuk",
    dash_logout: "Logout",

    // --- ADMIN PRODUCT FORM ---
    prod_form_title: "Tambah Produk Baru",
    prod_form_sub: "Masukkan detail produk dan resep gramasi.",
    prod_name: "Nama Produk",
    prod_name_ph: "cth: Almond Croissant",
    prod_cat: "Kategori",
    prod_sort: "Urutan Tampil",
    prod_notes: "Catatan Produksi",
    prod_notes_ph: "Opsional...",
    prod_is_base_label: "Ini ADALAH Produk Base (Menghasilkan Stok Sisa / Raw)",
    prod_deducts_from: "Mengurangi Stok Dari (Shaping):",
    prod_deducts_ph: "Pilih Base (Opsional)...",
    prod_proof_min: "Proofing (Menit)",
    prod_bake_min: "Baking (Menit)",
    prod_bake_temp: "Temp (°C)",
    prod_recipe_title: "Resep Gramasi",
    prod_recipe_sub: "Bahan baku yang digunakan per 1 unit produksi",
    prod_ing_label: "Bahan Baku",
    prod_amount_label: "Jumlah",
    btn_remove: "Hapus",
    prod_add_ing: "Tambah Bahan",
    prod_btn_save: "Simpan Produk Baru",
  ...
  en: {
    ...
    // --- ADMIN PRODUCT FORM ---
    prod_form_title: "Add New Product",
    prod_form_sub: "Enter product details and recipe.",
    prod_name: "Product Name",
    prod_name_ph: "e.g., Almond Croissant",
    prod_cat: "Category",
    prod_sort: "Sort Order",
    prod_notes: "Production Notes",
    prod_notes_ph: "Optional...",
    prod_is_base_label: "This IS a Base Product (Generates Source Stock)",
    prod_deducts_from: "Deducts Shaping Stock From:",
    prod_deducts_ph: "Select Base (Optional)...",
    prod_proof_min: "Proofing (Mins)",
    prod_bake_min: "Baking (Mins)",
    prod_bake_temp: "Temp (°C)",
    prod_recipe_title: "Recipe (Gramasi)",
    prod_recipe_sub: "Raw materials used per 1 item produced",
    prod_ing_label: "Ingredient",
    prod_amount_label: "Amount",
    btn_remove: "Remove",
    prod_add_ing: "Add Ingredient",
