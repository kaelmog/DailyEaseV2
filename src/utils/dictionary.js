...
export const dict = {
  id: {
    ...
    dash_subtitle: "Pilih modul yang ingin diakses.",
    dash_closing: "📝 Closing Harian",
    dash_closing_sub: "Input sales, inventori, dan gramasi.",
    dash_history: "🕰️ Riwayat Laporan",
    ...
    select_prompt: "Pilih outlet di atas untuk mulai closing.",
    ...
    live_display_title: "🏪 Live Display Sisa Summary",
    live_frozen_title: "❄️ Live Frozen Sisa Summary",
    ...
    report_1: "1. Sales Report",
    report_2: "2. Product Sales Amount",
    report_3_cinere: "3. Sisa Produk",
    report_3_normal: "3. Frozen & Display",

    // --- BUTTONS ---
    btn_review: "Review & Share WA",
    btn_submit_db: "🚀 Submit Laporan ke Database",
    btn_back: "← Kembali",
    btn_copy: "📋 Copy",
    btn_wa: "💬 WA",
    btn_add: "Tambah",
    ...
    expense_placeholder: "e.g., Beli Plastik",
    ...
    prod_is_base: "Ini ADALAH Produk Dasar (Sumber Adonan)",
    ...
    out_type_fresh: "Fresh Bake (Membentuk Adonan)",
    out_type_frozen: "Frozen Goods (Hanya Memanaskan)",
    out_btn_add: "Tambah Outlet",
    out_active: "🟢 Aktif",
    out_disabled: "🔴 Nonaktif",
    out_title_2: "2. Konfigurasi Outlet",
  ...
  en: {
    ...
    report_1: "1. Sales Report",
    report_2: "2. Product Sales Amount",
    report_3_cinere: "3. Product Leftovers",
    report_3_normal: "3. Frozen & Display",
    ...
    out_title_2: "2. Outlet Configurations",
